...
export default function HomePage() {
  ...
  const [showInstructionsForIndex, setShowInstructionsForIndex] = useState<
    number | null
  >(null);
  ...
  const handleSubmit = async (selectedResult?: SearchResult) => {
    ...
    if (
      ...
      toast.error(
        "Please describe what you want to build with this brand's styles",
      );
      return;
    }
    ...
    <HeaderProvider>
      <div className="min-h-screen bg-background-base">
                    ...
                    {hasSearched && searchResults.length > 0 && !isFadingOut ? (
                      <>
                        ...
                        >
                          ...
                          >
                            <path
                              d="M14 14L10 10M11 6.5C11 9 9 11 6.5 11C4 11 2 9 2 6.5C2 4 4 2 6.5 2C9 2 11 4 11 6.5Z"
                              stroke="currentColor"
                              strokeWidth="1.5"
                              strokeLinecap="round"
                            />
                  ...
                  >
                    <div className="px-[28px] pt-0 pb-[28px]">
                      <div className="border-t border-gray-100 bg-white">
                            ...
                            <div className="flex justify-end">
                              ...
                              >
                                <div
                                  ...
                                  style={{
                                    background:
                                      "color(display-p3 0.9059 0.3294 0.0784)",
                                    backgroundColor: "#FA4500",
                                  }}
                                />
                                <div
                                  ...
                                  style={{
                                    ...
                                    height: "16px",
                                    boxShadow:
                                      "rgba(0, 0, 0, 0.06) 0px 6px 12px -3px, rgba(0, 0, 0, 0.06) 0px 3px 6px -1px, rgba(0, 0, 0, 0.04) 0px 1px 2px 0px, rgba(0, 0, 0, 0.08) 0px 0.5px 0.5px 0px",
                                    transform: extendBrandStyles
                                      ? "translateX(16px)"
                                      : "none",
                                  }}
                                />
                        ...
                        <div
                          className={`flex items-center gap-3 mt-2 pb-4 transition-all duration-300 transform ${
                            isValidUrl
                              ? "translate-y-0 opacity-100"
                              : "-translate-y-2 opacity-0"
                          }`}
        ...
        {showSearchTiles && hasSearched && (
          <section
            className={`carousel-section relative w-full overflow-hidden mt-32 mb-32 transition-opacity duration-500 ${
          ...
          >
            ...
            {isSearching ? (
              ...
              <div className="relative h-[250px] overflow-hidden">
                {/* Edge fade overlays */}
                <div
                  className="absolute left-0 top-0 bottom-0 w-[120px] z-20 pointer-events-none"
                  style={{
                    background:
                      "linear-gradient(to right, white 0%, white 20%, transparent 100%)",
                  }}
                />
                <div
                  className="absolute right-0 top-0 bottom-0 w-[120px] z-20 pointer-events-none"
                  style={{
                    background:
                      "linear-gradient(to left, white 0%, white 20%, transparent 100%)",
                  }}
                />
                  ...
                  {[...Array(10), ...Array(10)].map((_, index) => (
                    ...
                    >
                      ...
                      <div className="absolute top-44 left-4 right-4">
                        ...
                        <div
                          className="h-3 bg-gray-150 rounded w-1/2 mb-2 animate-pulse"
                          style={{ animationDelay: "0.2s" }}
                        />
                        <div
                          className="h-3 bg-gray-150 rounded w-2/3 animate-pulse"
